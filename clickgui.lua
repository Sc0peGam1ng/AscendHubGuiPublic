...
local C = {
    BG = Color3.fromRGB(15, 16, 16),
    SB = Color3.fromRGB(13, 14, 14),
    SBH = Color3.fromRGB(25, 26, 26),
    SBA = Color3.fromRGB(31, 32, 32),
    CT = Color3.fromRGB(11, 12, 12),
    CD = Color3.fromRGB(20, 21, 21),
    CDH = Color3.fromRGB(25, 26, 26),
    ...
    BD = Color3.fromRGB(38, 40, 39),
    TO = Color3.fromRGB(53, 55, 54),
...
local ICONS = {
    ...
    Main = "rbxassetid://10723424646",
    Farm = "rbxassetid://10723396000",
...
local function makeDropdown(parent, text, options, default, cb)
    local row = ui("TextButton", parent, {
        Size = UDim2.new(1, 0, 0, 38), BackgroundColor3 = C.CDH,
    ...
    local value = ui("TextLabel", row, {Size = UDim2.fromOffset(116, 38), Position = UDim2.new(1, -42, 0, 0), AnchorPoint = Vector2.new(1, 0), BackgroundTransparency = 1, Text = default or options[1], TextColor3 = C.TS, TextSize = 13, Font = FONT, TextXAlignment = Enum.TextXAlignment.Right, TextYAlignment = Enum.TextYAlignment.Center, ZIndex = 9})
    local arrow = ui("TextLabel", row, {Size = UDim2.fromOffset(18, 38), Position = UDim2.new(1, -12, 0, 0), AnchorPoint = Vector2.new(1, 0), BackgroundTransparency = 1, Text = "▼", TextColor3 = C.TS, TextSize = 10, Font = FONT_BOLD, TextXAlignment = Enum.TextXAlignment.Center, TextYAlignment = Enum.TextYAlignment.Center, ZIndex = 9})
